...
fluke_rate = 0.2344; % Change indexing to calculate from a subset of the data (i.e only ascents)
cutoff = 0.1 % Change indexing to calculate from a subset of the data (i.e only ascents)
