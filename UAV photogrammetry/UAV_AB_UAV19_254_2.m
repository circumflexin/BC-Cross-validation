...
%% config
upstream_dir = 'D:\Raw\CAS 2019\Data\UAV\2019_09_11\02_0945';
downstream_dir = 'D:\Analysis\Cross validation\UAV photogrammetry\outputs';
video_name = '02_0743a.MOV'
whale_id = "357"
julian_day = "254"
UAV_flight_id = "UAV19_254_2"
tags = join(["SW19_253c"])
UAV_logfile = 'DJIFlightRecord_2019-09-11_[09-43-52]_verb.csv'
sync_pic = '02_0743a.JPG'
lens_cal = 'D:\Analysis\Cross validation\UAV photogrammetry\p4nonprocal'
LiDAR_logfile = 'UAV19_254_2_lid.csv'
...
im_info = imfinfo(fullfile(upstream_dir,sync_pic))
imshow(fullfile(upstream_dir,sync_pic))
gps_time = datetime('11-Sep-2019 07:43:12'); % look at the image and input the time on the hh GPS
...
vid_sync = table(datetime('11-Sep-2019 07:43:19'),30) %datetime in frame, frame number
